    ...
    <div id="box-input-search" style="display: flex; justify-content: center; margin: 40px 0">
        <div class="card" style="width: 20rem; padding: 20px">
            <div class="card-body">
                ...
                <p class="card-text">Bạn đã đặt hàng thành công. Sẽ có nhân viên liên hệ với bạn để xác nhận đơn hàng. Mã Hóa đơn chi tiết của bạn ở phía dưới</p>
                <a href="/look-up-order" class="card-link">${codeBill}</a>
            </div>
        </div>
    </div>
    <div id="order-detail">
