...
public interface ISanPhamRepository extends IBaseRepository<SanPham, Long> {
    ...
    @Query(value = """
            ...
            GROUP BY sp.id, sp.ten_san_pham, th.ten_thuong_hieu, xx.ten_xuat_xu, dm.ten_danh_muc, sp.ngay_tao
            ORDER BY sp.ngay_tao DESC
            """, nativeQuery = true)
    List<IProductItem> getLstProductGroup(@Param("search") String search);
}
